...
Esta página detalha os objetivos, entregas, metodologia e recursos essenciais para o projeto de desenvolvimento e competição de um robô seguidor de linha, culminando na documentação e publicação dos resultados.
...
A competição será conduzida presencialmente, com as seguintes datas e locais estabelecidos para o primeiro semestre de 2026:

-   **Disputa final:** 18 de Maio de 2025
-   **Horário:** 19:00h
-   **Local:** saguão principal (entrada do prédio) da unidade Anhanguera Marte
...
*   1º lugar: 40 horas complementares e certificado
...
*   **Roda Boba:** Roda boba metálica
    *   Quantidade: 1
*   **Chassi:** Acrílico ou outro material cortado, ou compra pronto
    *   Quantidade: 1
*   **Bateria:** baterias 18650 reaproveitadas
    *   Quantidade: 2
*   **Fios Jumper:** Kit de fios jumper macho-macho e macho-fêmea
    *   Quantidade: 1 kit
*   Ferro de solda, estanho, sugador de solda, multímetro, ferramentas
    *   Quantidade: 1 kt
...
-   Considerar o uso de plataformas para o diário. Sugestão: Google Docs (devido à integração com o NotebookLM).
...
*  No primeiro semestre a publicação ocorrerá no Zenodo, e no 2º no EAC.
...
*   **PCB (Printed Circuit Board):** placa de circuitoimpresso.
...
<br><sub>Last edited: 2026-02-01 18:10:20</sub>
